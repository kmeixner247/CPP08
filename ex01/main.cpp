...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/07/06 13:56:17 by kmeixner          #+#    #+#             */
/*   Updated: 2022/07/06 15:52:10 by kmeixner         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main()
{
	...
	std::cout << std::string(80, '-') << std::endl;
	std::cout << "BIG BOI TEST! Creating Span spE(250000) and filling it with random numbers" << std::endl;
	Span spE(250000);
	srand(time(NULL));
	...
	std::cout << std::string(80, '-') << std::endl;
	std::cout << "BIG BOI TEST2! Creating Span spF(250000) and filling it with consecutive numbers" << std::endl;
	Span spF(250000);
	std::vector<int> v;
	for (int i = 0; i < 250000; i++)
		v.push_back(i);
